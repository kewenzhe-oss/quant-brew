...
-- =============================================================================
-- AI Plan Builder: User Confirmed DCA / Staged Entry Plans
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS qd_plans (
    ...
    status VARCHAR(30) DEFAULT 'active',   -- draft / active / paused / completed / cancelled / archived
    total_budget DECIMAL(20,2),
    duration VARCHAR(50),
    frequency VARCHAR(50),
    risk_profile VARCHAR(50),
    thesis TEXT DEFAULT '',
    plan_json TEXT NOT NULL,               -- structured AI draft JSON stored as string
...
CREATE INDEX IF NOT EXISTS idx_plans_user_id ON qd_plans(user_id);
CREATE INDEX IF NOT EXISTS idx_plans_status ON qd_plans(status);
CREATE INDEX IF NOT EXISTS idx_plans_created_at ON qd_plans(created_at);
