...
class BacktestService:
    ...
    def _fetch_kline_data(
        ...
        # Calculate before_time as UTC epoch (end_date + 1 day).
        # Use calendar.timegm so that naive datetime objects are interpreted as
        # UTC regardless of the server's local timezone — this must match CCXT
        # which always works in UTC milliseconds.
        import calendar
